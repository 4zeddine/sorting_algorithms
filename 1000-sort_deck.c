...
/**
 * insertion_sort_deck_type - sorts a deck of cards from spades to diamonds.
 * @deck: a pointer to the head of the deck's doubly-linked list.
 */
void insertion_sort_deck_type(deck_node_t **deck)
{
...
/**
 * insertion_sort_deck_value - Sorts a deck of cards by value.
 * @deck: A pointer to the head of the deck's doubly-linked list.
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
